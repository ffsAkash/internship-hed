...
!(function (p) {
  ...
  (r.prototype.respChart = function (r, o, e, t) {
    ...
    (r.prototype.init = function () {
      var r,
        o = getChartColorsArray("lineChart");
      o &&
        ((r = {
          labels: [
            "January",
      ...
      var e,
        t = getChartColorsArray("doughnut");
      t &&
        ((e = {
      ...
      var u,
        C = getChartColorsArray("polarArea");
      C &&
        ((u = {
          datasets: [
            {
        ...
        this.respChart(p("#polarArea"), "PolarArea", u));
    }),
    (p.ChartJs = new r()),
